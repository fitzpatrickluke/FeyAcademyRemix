...
if(manager_students.master_student_1 == student_paige)
	instance_destroy(id);
...
var j = 0;
var tl = manager_text.txt_paige_length;
var t = manager_text.txt_paige;
...
spr_R = spr_paige_walk_right;
spr_L = spr_paige_walk_left;
spr = spr_R;

spr_full = student_paige.spr;

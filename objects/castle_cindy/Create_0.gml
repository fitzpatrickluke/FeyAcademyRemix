...
if(manager_students.master_student_1 == student_cindy)
	instance_destroy(id);
...
var j = 0;
var tl = manager_text.txt_cindy_length;
var t = manager_text.txt_cindy;
...
spr_R = spr_cindy_walk_right;
spr_L = spr_cindy_walk_left;
spr = spr_R;

spr_full = student_cindy.spr;

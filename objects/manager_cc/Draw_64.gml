...
draw_sprite_ext(spr_background,0,0,0,scale,scale,0,c_white,1);
...
if(mouseX >= menu_l_select_x_2 && mouseX < menu_l_select_x_2 + menu_select_w
&& mouseY >= menu_l_select_y_0 && mouseY < menu_l_select_y_0 + menu_select_h)
	draw_sprite_part_ext(spr_background,1,0,24,menu_select_w/scale,menu_select_h/scale,menu_l_select_x_2,menu_l_select_y_0,scale,scale,c_white,1);
...
draw_text_color(txt_menu_l_x,txt_menu_l_y_4, "Hair Col",txtColor,txtColor,txtColor,txtColor,1);
draw_text_color(txt_menu_l_x,txt_menu_l_y_5, "",txtColor,txtColor,txtColor,txtColor,1);
...
draw_text_color(txt_menu_r_x,txt_menu_r_y_2, "Top Col",txtColor,txtColor,txtColor,txtColor,1);
draw_text_color(txt_menu_r_x,txt_menu_r_y_3, "Bottom",txtColor,txtColor,txtColor,txtColor,1);
draw_text_color(txt_menu_r_x,txt_menu_r_y_4, "Bot Col",txtColor,txtColor,txtColor,txtColor,1);
draw_text_color(txt_menu_r_x,txt_menu_r_y_5, "Shoes",txtColor,txtColor,txtColor,txtColor,1);
draw_text_color(txt_menu_r_x,txt_menu_r_y_6, "Shoes Col",txtColor,txtColor,txtColor,txtColor,1);
draw_text_color(txt_menu_r_x,txt_menu_r_y_7, "Accessory",txtColor,txtColor,txtColor,txtColor,1);
draw_text_color(txt_menu_r_x,txt_menu_r_y_8, "Acc Col",txtColor,txtColor,txtColor,txtColor,1);
...
if(spr_hair_col_num < 8)
	draw_sprite_part_ext(spr_hair,spr_hair_num,0,320*spr_hair_col_num,320,320,port_x,port_y,0.5,0.5,c_white,1);
else
	draw_sprite_part_ext(spr_hair_2,spr_hair_num,0,320*(spr_hair_col_num-8),320,320,port_x,port_y,0.5,0.5,c_white,1);
}
...
draw_sprite_ext(spr_body,spr_body_num,port_x,port_y,0.5,0.5,0,c_white,1)
// face
...
if(spr_top_col_num < 8)
	draw_sprite_part_ext(spr_top,spr_top_num,0,320*spr_top_col_num,320,320,port_x,port_y,0.5,0.5,c_white,1);
else
	draw_sprite_part_ext(spr_top_2,spr_top_num,0,320*(spr_top_col_num-8),320,320,port_x,port_y,0.5,0.5,c_white,1);
...
if(spr_hair_col_num < 8)
	draw_sprite_part_ext(spr_bang,spr_bang_num,0,320*spr_hair_col_num,320,320,port_x,port_y,0.5,0.5,c_white,1);
else
	draw_sprite_part_ext(spr_bang_2,spr_bang_num,0,320*(spr_hair_col_num-8),320,320,port_x,port_y,0.5,0.5,c_white,1);
...
if(spr_acc_col_num < 8)
	draw_sprite_part_ext(spr_acc,spr_acc_num,0,320*spr_acc_col_num,320,320,port_x,port_y,0.5,0.5,c_white,1);
else
	draw_sprite_part_ext(spr_acc_2,spr_acc_num,0,320*(spr_acc_col_num-8),320,320,port_x,port_y,0.5,0.5,c_white,1);

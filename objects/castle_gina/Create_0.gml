...
if(manager_students.master_student_1 == student_gina)
	instance_destroy(id);
...
var j = 0;
var tl = manager_text.txt_gina_length;
var t = manager_text.txt_gina;
...
spr_R = spr_gina_walk_right;
spr_L = spr_gina_walk_left;
spr = spr_R;

spr_full = student_gina.spr;

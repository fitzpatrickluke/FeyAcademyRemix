...
if(manager_students.master_student_1 == student_lapis)
	instance_destroy(id);
...
var j = 0;
var tl = manager_text.txt_lapis_length;
var t = manager_text.txt_lapis;
...
spr_R = spr_lapis_walk_right;
spr_L = spr_lapis_walk_left;
spr = spr_R;

spr_full = student_lapis.spr;

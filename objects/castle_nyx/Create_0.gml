...
if(manager_students.master_student_1 == student_nyx)
	instance_destroy(id);
...
var j = 0;
var tl = manager_text.txt_nyx_length;
var t = manager_text.txt_nyx;
...
spr_R = spr_nyx_walk_right;
spr_L = spr_nyx_walk_left;
spr = spr_R;

spr_full = student_nyx.spr;

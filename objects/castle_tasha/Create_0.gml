...
if(manager_students.master_student_1 == student_tasha)
	instance_destroy(id);
...
var j = 0;
var tl = manager_text.txt_tasha_length;
var t = manager_text.txt_tasha;
...
spr_R = spr_tasha_walk_right;
spr_L = spr_tasha_walk_left;
spr = spr_R;

spr_full = student_tasha.spr;

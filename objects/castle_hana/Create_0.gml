...
if(manager_students.master_student_1 == student_hana)
	instance_destroy(id);
...
var j = 0;
var tl = manager_text.txt_hana_length;
var t = manager_text.txt_hana;
...
spr_R = spr_hana_walk_right;
spr_L = spr_hana_walk_left;
spr = spr_R;

spr_full = student_hana.spr;

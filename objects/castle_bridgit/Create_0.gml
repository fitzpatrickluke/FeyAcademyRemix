...
if(manager_students.master_student_1 == student_bridgit)
	instance_destroy(id);
txt[0] = "";
txt_length = 1;

var j = 0;
var tl = manager_text.txt_bridgit_length;
var t = manager_text.txt_bridgit;
...
spr_R = spr_bridgit_walk_right;
spr_L = spr_bridgit_walk_left;
spr = spr_R;

spr_full = student_bridgit.spr;

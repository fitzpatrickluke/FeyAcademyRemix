...
if(manager_students.master_student_1 == student_vivian)
	instance_destroy(id);
...
var j = 0;
var tl = manager_text.txt_vivian_length;
var t = manager_text.txt_vivian;
...
spr_R = spr_vivian_walk_right;
spr_L = spr_vivian_walk_left;
spr = spr_R;

spr_full = student_vivian.spr;

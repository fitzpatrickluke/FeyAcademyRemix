...
if(mouse_check_button_pressed(mb_left))
{
	...
	&& mouseY >= finish_select_y && mouseY < finish_select_y+finish_select_h)
	{
		...
		manager_castle.spr_body_num = spr_body_num;
		manager_castle.spr_hair_num = spr_hair_num;
		manager_castle.spr_bang_num = spr_bang_num;
		manager_castle.spr_hair_col_num = spr_hair_col_num;
		manager_castle.spr_eye_num = spr_eye_num;
		manager_castle.spr_top_num = spr_top_num;
		manager_castle.spr_top_col_num = spr_top_col_num;
		manager_castle.spr_bot_num = spr_bot_num;
		manager_castle.spr_bot_col_num = spr_bot_col_num;
		manager_castle.spr_shoe_num = spr_shoe_num;
		manager_castle.spr_shoe_col_num = spr_shoe_col_num;
		manager_castle.spr_acc_num = spr_acc_num;
		manager_castle.spr_acc_col_num = spr_acc_col_num;

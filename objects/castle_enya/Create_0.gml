ph = phase.phase_start;
	if(manager_students.master_student_1 == student_enya)
	instance_destroy(id);
txt[0] = "";
txt_length = 1;

var j = 0;
var tl = manager_text.txt_enya_length;
var t = manager_text.txt_enya;
...
spr_R = spr_enya_walk_right;
spr_L = spr_enya_walk_left;
spr = spr_R;

spr_full = student_enya.spr;
